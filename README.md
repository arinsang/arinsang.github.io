...
The data above depicts the causes of geographic mobility in the U.S. Two of the components being evicted out of the individuals' home or due to finding new employment in another location. As seen, the rate at which people move due to being evicted is, on average, notably less in most recent years than previously. The peak at which people moved because of this reason was between 2011-2013. Compared to housing related causes, the data portraying employment causes did not fluctuate as much-- or even as significantly at all in its isolated view. The reason for migrating due to new employment ranges from about 4.2% to 6.5%. It is notably at its lowest percentage during 2008 most likely due to the great U.S. economic recession. 
